...
class StatisticsQueries:
    ...
    def _add_date_filter_to_query(self, query: BaseQuery, start_date: datetime.datetime,
    ...
    def get_routes_data(self, start_date: datetime.datetime, end_date: datetime.datetime) -> List:
        query = (self.db.session.query(self.model.path,
                                       ...
                                       func.avg(self.model.response_time).label("average_response_time")).filter(
    ...
    def get_requests_for_path(self, path: str, start_date: datetime.datetime, end_date: datetime.datetime) -> List:
        query = (self.db.session.query(self.model).filter(self.model.path == path).order_by(self.model.date.desc()))
